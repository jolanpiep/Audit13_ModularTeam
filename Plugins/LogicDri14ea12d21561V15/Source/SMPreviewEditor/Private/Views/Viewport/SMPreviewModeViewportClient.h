...
{
public:
	explicit FSMAdvancedPreviewScene(const ConstructionValues& CVS, const TSharedPtr<FSMStateMachineBlueprintEditor>& InEditor, float InFloorOffset = 0.0f);
...
protected:
	...
	TArray<TObjectPtr<UActorComponent>> OurComponents;
